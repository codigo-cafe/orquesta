	...
	<app-layout>
		...
		<div class="row">
			<div class="col-12 mt-2">
				<div class="card">
					<div class="card-body">
						<h6 class="card-title text-dark text-gradient">Lista de Eventos</h6>
						<div class="toolbar">
							<div class="row">
			                    <div class="col-sm-auto">
	                        		...
	                        		<div class="input-group mb-4">
	                        			...
	                        			<input class="form-control" id="Filter" placeholder="Buscar Evento" type="text" >
	                        		</div>
			                    </div>
			                    <div class="col-sm-auto">
	...
	methods: {
		...
		datatables() {
			this.$nextTick(() => {
				...
				var titulo = "Reporte de Eventos";
				var anchos = ['5%', '20%', '10%', '10%', '15%', '10%', '10%', '10%', '10%'];
				self.table = $('#datatables').DataTable({
					"processing": true,
					"serverSide": true,
					"ajax": "/events/listreport",
					"columns": [
					{data : 'id'},
					{data : 'name'},
					{data : 'category.name'},
