							...
							<div class="row">
			                    <div class="col-sm-auto">
	                        		...
	                        		<div class="input-group mb-4">
	                        			...
	                        			<input class="form-control" id="Filter" placeholder="Buscar Punto de Venta" type="text" >
	                        		</div>
			                    </div>
			                    <div class="col-sm-auto">
	...
	methods: {
		...
		datatables() {
			this.$nextTick(() => {
		        ...
		        var titulo = "Reporte de Puntos de Venta";
		        var anchos = ['10%', '15%', '20%', '15%', '20%', '20%'];
				...
				$('input[type=radio][name=searchEstado]').change(function() {
					if (this.value == 'Todos'){
						...
						self.table.columns(3).search(1).draw();
					}else if (this.value == 'Inactivo') {
						self.table.columns(3).search(0).draw();
					}
				});
			})
		}
