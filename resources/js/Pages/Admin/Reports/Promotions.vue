							...
							<div class="row">
								<div class="col-sm-auto">
									...
									<div class="input-group mb-4">
										...
										<input class="form-control" id="Filter" placeholder="Buscar Promoción" type="text" >
									</div>
								</div>
								<div class="col-sm-auto">
	...
	methods: {
		...
		datatables() {
			this.$nextTick(() => {
				...
				var titulo = "Reporte de Promociones";
				var anchos = ['5%', '10%', '15%', '10%', '10%', '10%', '10%', '15%', '15%'];
				...
				$('input[type=radio][name=searchEstado]').change(function() {
					if (this.value == 'Todos'){
						...
						self.table.columns(6).search(1).draw();
					}else if (this.value == 'Inactivo') {
						self.table.columns(6).search(0).draw();
					}
				});
			})
		}
