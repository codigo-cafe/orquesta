                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="team-player">
                                    ...
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-twitter"></i></a>
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-instagram"></i></a>
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-facebook-square"></i></a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="team-player">
                                    ...
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-twitter"></i></a>
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-linkedin"></i></a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="team-player">
                                    ...
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-google-plus"></i></a>
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-youtube"></i></a>
                                    <a href="#pablo" class="btn btn-cafe btn-icon btn-round"><i class="fab fa-twitter"></i></a>
                                </div>
                            </div>
                        </div>
