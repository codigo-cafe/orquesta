			...
			<form @submit.prevent="submit">
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="modal-title" id="ModalLabel">Registrar Persona</h6>
					...
					<div class="modal-body">
						<div class="row">
							<div class="text-center" :class="{ 'col-md-12': img == '', 'col-md-4-animate': img != '' }">
								...
								<div class="m-2">
									<img :src="photoPreview" alt="Perfil Persona" class="m-auto d-flex avatar avatar-xxl rounded-circle shadow-lg">
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group bmd-form-group" :class="{ 'has-danger': errors.name }">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" id="c_name" placeholder="Nombre de la persona" v-model="form.name" @input="onChangeName">
									</div>
							...
							<div class="col-md-6">
								<div class="form-group bmd-form-group" :class="{ 'has-danger': errors.surnames }">
									<label for="c_surnames">Apellidos</label>
									<div class="input-group">
										<span class="input-group-text"><i class="fas fa-feather-alt"></i></span>
										<input type="text" class="form-control" id="c_surnames" placeholder="Apellidos de la persona" v-model="form.surnames" @input="onChangeName">
									</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group bmd-form-group" :class="{ 'has-danger': errors.phone }">
									<label for="c_phone">Número de contacto</label>
									<div class="input-group">
										<span class="input-group-text"><i class="fas fa-phone"></i></span>
										<input type="text" class="form-control" id="c_phone" placeholder="Número de contacto" v-model="form.phone">
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group bmd-form-group" :class="{ 'has-danger': errors.type_id }">
									<label for="c_type_id">Tipo de Persona</label>
...
export default {
	...
	props: ['types', 'reload', 'showNotification'],
	...
	methods: {
		async submit() {
			this.disabled = true;
			axios.post(this.route('people.store'), this.form)
			.then(response => {
				this.disabled = false;
				this.closeModal();
				this.reload();
