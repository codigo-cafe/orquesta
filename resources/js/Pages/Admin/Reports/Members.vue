							...
							<div class="row">
			                    <div class="col-sm-auto">
	                        		...
	                        		<div class="input-group mb-4">
	                        			...
	                        			<input class="form-control" id="Filter" placeholder="Buscar Integrante" type="text" >
	                        		</div>
			                    </div>
			                    <div class="col-sm-auto">
	...
	methods: {
		...
		datatables() {
			this.$nextTick(() => {
		        ...
		        var titulo = "Reporte de Integrantes";
				...
				self.table = $('#datatables').DataTable({
					...
					"ajax": "/members/list",
					"columns": [
					{data : 'member.id', orderable: false, searchable: false},
					{data : 'name'},
					{data : 'surnames'},
